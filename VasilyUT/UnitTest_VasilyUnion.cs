...
namespace VasilyUT
{
    public class UnitTest_VasilyUnion
    {
        ...
        public void TestUnionCondition1()
        {
            ...
            var result = SqlUnion<Student>.Union(Sql<Student>.SelectAllByCondition + (condition > "Sid").GetConditionWithPage(), "table1", "table2", "table3");
        ...
        public void TestUnionCondition2()
        {
            SqlPackage<Student> package = new SqlPackage<Student>();
            SqlCondition<Student> condition = new SqlCondition<Student>();
            var result = SqlUnion<Student>.Union(Sql<Student>.SelectAllByCondition + (condition > "Sid").GetConditionWithPage());
